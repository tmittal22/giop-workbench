...
def test_bounded_plus_fit_shapes_is_refused():
    ...
    fixed-shape answer BITWISE identical to not asking for it, which reads as a
    successful shape fit. Refusing is the only safe behaviour until it is implemented.
    """
